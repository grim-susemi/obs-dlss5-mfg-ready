...
1. Download the zip. Grab `obs-dlss5-mfg-ready-prerelease.zip` (about 250 MiB) and `SHA256SUMS.txt` from the [latest pre-release page](https://github.com/grim-susemi/obs-dlss5-mfg-ready/releases/latest). Check the zip hash against `SHA256SUMS.txt` before you unpack.
